...
def render_body(body):
    ...
    if cols:
        ...
        pos = 0
        while pos < len(out) and out[pos].startswith('<p class="lead">'):
            pos += 1
        out.insert(pos, '<div class="cols">' + sep.join(cols) + "</div>")
